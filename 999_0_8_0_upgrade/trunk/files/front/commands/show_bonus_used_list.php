<?php
/**
 * Library containing the ShowBonusUsedListCommand base class.
 * @package Command
...
/**
 * Defines functionality for the showing the bonus used list.
 * @package Command
 * @author Roberto Oliveros
 */
class ShowBonusUsedListCommand extends Command{
	/**
	 * Execute the command.
	...
	public function execute(Request $request, SessionHelper $helper){
		...
		if(is_null($request->getProperty('show_reference'))){
			Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'blank.tpl',
					...
					'reference_name' => 'Ofertas Usadas',
					'reference_cmd' => 'index.php?cmd=show_bonus_used_list&page=1'),
					'site_html.tpl');
			return;
		}
		...
		try{
			$list = BonusList::getUsedList($start_date, $end_date, $total_pages, $total_items, $page);
		} catch(Exception $e){
			$msg = $e->getMessage();
			...
			Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'blank.tpl',
					'back_trace' => $back_trace, 'second_menu' => 'none',
					'reference_type' => LIST_TYPE, 'reference_name' => 'Ofertas Usadas',
					'reference_cmd' => 'index.php?cmd=show_bonus_used_list&page=1',
					'back_link' => 'index.php?cmd=show_report_menu_pos_admin',
		...
		if($total_items > 0){	
			...
			$link = 'index.php?cmd=show_bonus_used_list&show_reference&page=';
			...
			Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'back_link.tpl',
					...
					'bonus_used' => 1), 'site_html.tpl');
		}
		else {
			$msg = 'No hay ofertas usadas en esas fechas en la base de datos.';
			Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'back_link.tpl',
					'back_link' => 'index.php?cmd=show_report_menu_pos_admin', 'back_trace' => $back_trace,
