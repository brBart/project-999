<?php
/**
 * Library containing the ShowCashDocumentCancelLogCommand class.
 * @package Command
...
class ShowCashDocumentCancelLogCommand extends ShowLogCommand{
	...
	protected function showForm(){
		...
		Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'blank.tpl',
				...
				'reference_type' => LOG_TYPE, 'reference_name' => 'Documentos Anulados (Caja)',
				'reference_cmd' => 'index.php?cmd=show_cash_document_cancel_log&page=1',
	...
	protected function testRights(UserAccount $user){
		return AccessManager::isAllowed($user, 'cash_document_cancel_log', 'read');
	}
	...
	protected function getList($startDate, $endDate, &$totalPages, &$totalItems, $page){
		return CancelCashDocumentList::getList($startDate, $endDate, $totalPages, $totalItems, $page);
	}
	...
	protected function displayEmpty(){
		$back_trace = array('Inicio', 'Herramientas', 'Bitacoras');
		$msg = 'No hay documentos que fueron anulados en esas fechas en la base de datos.';
	...
	protected function displayList($list, $startDate, $endDate, $totalPages, $totalItems, $page, $firstItem,
		...
		Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'back_link.tpl',
				'back_link' => 'index.php?cmd=show_log_menu_pos_admin', 'back_trace' => $back_trace,
				'second_menu' => 'none', 'content' => 'document_cancel_log_html.tpl', 'log_name' => 'Documentos Anulados (Caja)',
				...
				'next_link' => $nextLink, 'print_cmd' => 'print_cash_document_cancel_log'), 'site_html.tpl');
	}
}
?>