<?php
/**
 * Library containing the ShowInvoiceTransactionLogCommand class.
 * @package Command
 ...
 * @author Roberto Oliveros
 */
class ShowInvoiceTransactionLogCommand extends ShowLogCommand{
	/**
	 * Show the empty form.
	 */
	protected function showForm(){
		...
		Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'blank.tpl',
				...
				'reference_type' => LOG_TYPE, 'reference_name' => 'Transacciones de Facturas',
				'reference_cmd' => 'index.php?cmd=show_invoice_transaction_log&page=1',
	...
	protected function getList($startDate, $endDate, &$totalPages, &$totalItems, $page){
		return InvoiceTransactionList::getList($startDate, $endDate, $totalPages, $totalItems, $page);
	}
	...
	protected function displayEmpty(){
		$back_trace = array('Inicio', 'Herramientas', 'Bitacoras');
		$msg = 'No hay transacciones en esas fechas en la base de datos.';
	...
	protected function displayList($list, $startDate, $endDate, $totalPages, $totalItems, $page, $firstItem,
		...
		Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'back_link.tpl',
				'back_link' => 'index.php?cmd=show_log_menu_pos_admin', 'back_trace' => $back_trace,
				'second_menu' => 'none', 'content' => 'invoice_transaction_log_html.tpl', 'log_name' => 'Transacciones de Facturas',
				...
				'next_link' => $nextLink, 'print_cmd' => 'print_invoice_transaction_log'), 'site_html.tpl');
	}
}
?>