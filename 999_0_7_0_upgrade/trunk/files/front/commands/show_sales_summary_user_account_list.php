<?php
/**
 * Library containing the ShowSalesSummaryUserAccountListCommand base class.
 * @package Command
...
/**
 * Defines functionality for the showing the sales summary list.
 * @package Command
 * @author Roberto Oliveros
 */
class ShowSalesSummaryUserAccountListCommand extends Command{
	/**
	 * Execute the command.
	...
	public function execute(Request $request, SessionHelper $helper){
		...
		if(is_null($request->getProperty('show_reference'))){
			Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'blank.tpl',
					...
					'reference_name' => 'Resumen de Ventas por Usuario',
					'reference_cmd' => 'index.php?cmd=show_sales_summary_user_account_list&page=1'),
					'site_html.tpl');
			return;
		}
		...
		try{
			$list = SalesSummaryList::getListByUserAccount($start_date, $end_date, $total, $total_pages, $total_items, $page);
		} catch(Exception $e){
			$msg = $e->getMessage();
			...
			Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'blank.tpl',
					'back_trace' => $back_trace, 'second_menu' => 'none',
					'reference_type' => LIST_TYPE, 'reference_name' => 'Resumen de Ventas por Usuario',
					'reference_cmd' => 'index.php?cmd=show_sales_summary_user_account_list&page=1',
					'back_link' => 'index.php?cmd=show_report_menu_pos_admin',
		...
		if($total_items > 0){	
			...
			$link = 'index.php?cmd=show_sales_summary_user_account_list&show_reference&page=';
			...
			Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'back_link.tpl',
					...
					'second_menu' => 'none', 'content' => 'sales_summary_user_account_list_html.tpl', 'list' => $list,
