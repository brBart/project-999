<?php
/**
 * Library containing the PrintCashDocumentCancelLogCommand class.
 * @package Command
 ...
 * @author Roberto Oliveros
 */
class PrintCashDocumentCancelLogCommand extends PrintLogCommand{
	/**
	...
	protected function getList($startDate, $endDate){
		return CancelCashDocumentList::getList($startDate, $endDate);
	}
	...
	protected function displayList($list, $startDate, $endDate, $totalItems){
		Page::display(array('log_name' => 'Documentos Anulados (Caja)', 'list' => $list, 'start_date' => $startDate,
