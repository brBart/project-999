...
<div id="third_menu">
	<ul>
	    <li>
	    	<form method="post" action="index.php?cmd=get_invoice_by_serial_number" onsubmit="return oSession.setIsLink(true);">
	    ...
	    <li id="li_last">
	    	<div id="dates_range">
		    	<form method="post" action="index.php?cmd=search_invoice&page=1"
