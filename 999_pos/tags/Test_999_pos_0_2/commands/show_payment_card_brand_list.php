<?php
/**
 * Library containing the ShowPaymentCardBrandListCommand class.
 * @package Command
...
/**
 * Implements functionality for showing the payment card brand list.
 * @package Command
 * @author Roberto Oliveros
 */
class ShowPaymentCardBrandListCommand extends ShowListCommand{
	/**
	...
	protected function getList(&$totalPages, &$totalItems, $page){
		return PaymentCardBrandList::getList($totalPages, $totalItems, $page);
	}
	...
	protected function displayEmpty(){
		...
		$msg = 'No hay marcas de tarjeta en la base de datos.';
		Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'back_link.tpl',
				'back_link' => 'index.php?cmd=show_payment_card_brand_menu', 'back_trace' => $back_trace,
	...
	protected function displayList($list, $totalPages, $totalItems, $page, $firstItem, $lastItem, $previousLink,
		...
		Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'back_link.tpl',
				...
				'next_link' => $nextLink, 'item_link' => 'index.php?cmd=get_payment_card_brand&id=',
