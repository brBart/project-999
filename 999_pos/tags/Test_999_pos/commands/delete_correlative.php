<?php
/**
 * Library containing the DeleteCorrelativeCommand class.
 * @package Command
...
/**
 * Implements functionality for deleting correlative objects.
 * @package Command
 * @author Roberto Oliveros
 */
class DeleteCorrelativeCommand extends DeleteObjectCommand{
	/**
