<?php
/**
 * Library containing the ShowShiftListCommand class.
 * @package Command
...
/**
 * Implements functionality for showing the shift list.
 * @package Command
 * @author Roberto Oliveros
 */
class ShowShiftListCommand extends ShowListCommand{
	/**
	...
	protected function getList(&$totalPages, &$totalItems, $page){
		return ShiftList::getList($totalPages, $totalItems, $page);
	}
	...
	protected function displayEmpty(){
		...
		$msg = 'No hay turnos de caja en la base de datos.';
		Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'back_link.tpl',
				'back_link' => 'index.php?cmd=show_shift_menu', 'back_trace' => $back_trace,
	...
	protected function displayList($list, $totalPages, $totalItems, $page, $firstItem, $lastItem, $previousLink,
		...
		Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'back_link.tpl',
				...
				'next_link' => $nextLink, 'item_link' => 'index.php?cmd=get_shift&id=',
