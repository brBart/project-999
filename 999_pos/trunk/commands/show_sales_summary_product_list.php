<?php
/**
 * Library containing the ShowSalesSummaryProductListCommand base class.
 * @package Command
 ...
 * @author Roberto Oliveros
 */
class ShowSalesSummaryProductListCommand extends Command{
	/**
	 * Execute the command.
	...
	public function execute(Request $request, SessionHelper $helper){
		...
		if(is_null($request->getProperty('show_report'))){
			Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'blank.tpl',
					...
					'content' => 'sales_list_form_html.tpl', 'report_name' => 'Resumen de Ventas por Producto'),
					'site_html.tpl');
			return;
		}
		...
		try{
			...
			Page::display(array('module_title' => POS_ADMIN_TITLE, 'main_menu' => 'blank.tpl',
					'back_trace' => $back_trace, 'second_menu' => 'none',
					'report_name' => 'Resumen de Ventas por Producto',
					'back_link' => 'index.php?cmd=show_report_menu_pos_admin',
					'content' => 'sales_list_form_html.tpl', 'notify' => '1', 'type' => 'error',
		...
		if($total_items > 0){	
			...
			$link = 'index.php?cmd=show_sales_summary_product_list&show_report&page=';
