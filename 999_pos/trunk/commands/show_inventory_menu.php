<?php
/**
 * Library containing the ShowInventoryMenuCommand class.
 * @package Command
...
/**
 * Command to display the inventory menu.
 * @package Command
 * @author Roberto Oliveros
 */
class ShowInventoryMenuCommand extends Command{
	/**
	 * Execute the command.
	...
	public function execute(Request $request, SessionHelper $helper){
		$back_trace = array('Inicio', 'Inventariados');
