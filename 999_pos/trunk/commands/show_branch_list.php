<?php
/**
 * Library containing the ShowBranchListCommand class.
 * @package Command
...
/**
 * Implements functionality for showing the branch list.
 * @package Command
 * @author Roberto Oliveros
 */
class ShowBranchListCommand extends ShowListCommand{
	/**
	...
	protected function getList(&$totalPages, &$totalItems, $page){
		return BranchList::getList($totalPages, $totalItems, $page);
	}
	...
	protected function displayList($list, $totalPages, $totalItems, $page, $firstItem, $lastItem, $previousLink,
		...
		Page::display(array('module_title' => OPERATIONS_TITLE, 'main_menu' => 'back_link.tpl',
				...
				'next_link' => $nextLink, 'item_link' => 'index.php?cmd=get_branch&id=',
