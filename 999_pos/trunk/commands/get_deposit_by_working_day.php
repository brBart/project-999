...
class GetDepositByWorkingDayCommand extends GetObjectCommand{
	...
	protected function getObject(){
		$id = Deposit::getDepositIdByWorkingDay(
				WorkingDay::getInstance($this->_mRequest->getProperty('deposit_working_day')),
	...
	protected function displayObject($key, $obj, $backQuery){
		...
		$working_day = WorkingDay::getInstance($this->_mRequest->getProperty('deposit_working_day'));
