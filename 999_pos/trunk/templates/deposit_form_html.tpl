	...
	<div id="frm" class="content_large">
		...
		<fieldset id="main_data" class="pos disabled">
			<p>
		  		...
		  		<object id="deposit_number_input" type="application/x-deposit_number_line_edit"></object>
		  		<span id="deposit_number-failed" class="hidden">*</span>
		  	</p>
		  	<p>
		  		<label id="bank_account_label">Cuenta bancaria:</label>
		  		<object id="bank_account_input" type="application/x-bank_account_combo_box"></object>
