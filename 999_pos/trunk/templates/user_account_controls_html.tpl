...
<script type="text/javascript" src="../scripts/save_user_account.js"></script>
{if $status eq 1}
<script type="text/javascript" src="../scripts/edit.js"></script>
<script type="text/javascript" src="../scripts/delete.js"></script>
{/if}
<script type="text/javascript">
var oSave = new SaveUserAccountCommand(oSession, oConsole, Request.createXmlHttpRequestObject(), {$key});
{if $status eq 1}
...
<script type="text/javascript">
oSave.init('{$password_id}', '{$confirm_id}');
</script>