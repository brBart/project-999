...
<div id="product_tb" class="small_tb">
 	<div>
		...
		<input name="form_widget" id="upload_file" type="button" value="Subir archivo..." onclick="window.open('index.php?cmd=show_upload_file','','left=20,top=20,width=500,height=100,toolbar=0,resizable=0');" />
	</div>
</div>
<script type="text/javascript">
