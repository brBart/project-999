...
<script type="text/javascript" src="../scripts/search_product_reserve.js"></script>
<script type="text/javascript">
	...
	var oSearchDetails = new SearchProductReserve(oSession, oSearchProduct, oEventDelegator);
</script>
<div id="third_menu">
	<ul>
	    <li>
	    ...
	    <li>
	    	<form method="post" action="index.php?cmd=get_reserve_product_by_id" onsubmit="return oSession.setIsLink(true);">
	    ...
	    <li id="li_last">
	    	<form method="post" action="index.php?cmd=get_reserve_product_by_bar_code" onsubmit="return oSession.setIsLink(true);">
	    		<label for="bar_code">C&oacute;digo barra:</label>
	    		<input name="bar_code" id="bar_code" type="text" value="{$bar_code}" maxlength="50" />
	    		<input type="submit" value="Consultar" />
	    	</form>
	    </li>
	</ul>
