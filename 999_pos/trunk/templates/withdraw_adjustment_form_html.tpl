...
<div id="content">
	<div id="frm" class="content_large">
		...
		{include file='header_data_html.tpl' document_name='Vale de Salida'}
		...
		{include file='controls_doc_html.tpl' print_cmd='print_withdraw_adjustment' cancel_cmd='cancel_withdraw_adjustment'}
	</div>
</div>
<script type="text/javascript">
{if $status eq 0}
